    ...
    public partial class peru : Form
    {
        ...
        void TareaSecundaria(object statusLabelObject, object deads, object lives, object DatagridView)
        {
            ...
            void primer()
            {
              ...
              //  options.AddArgument("--headless");
                ...
                { 
                    ...
                    driver.Navigate().GoToUrl("https://www.gef.co/727371-010760");
                    ...
                    Thread.Sleep(5000);
                    driver.FindElement(By.XPath("/html/body/main/div[1]/div[2]/div/div[1]/div/div/div/div[2]/div/a")).Click();
                    Thread.Sleep(5000);
                    wait.Until(driver1 => ((IJavaScriptExecutor)driver).ExecuteScript("return document.readyState").Equals("complete"));
                    driver.FindElement(By.XPath("//*[@id='input-email']")).SendKeys(correo + "@gmail.com" + Keys.Enter);
                    wait.Until(driver1 => ((IJavaScriptExecutor)driver).ExecuteScript("return document.readyState").Equals("complete"));
                    driver.FindElement(By.XPath("//*[@id='input-first-name']")).SendKeys("Luisberto");
                    driver.FindElement(By.XPath("//*[@id='input-last-name']")).SendKeys("Catar");
                    Thread.Sleep(2000);
                    driver.FindElement(By.XPath("//*[@id='input-password']")).SendKeys("4rfv5tgb6yhn..");
                    ...
                    wait.Until(driver1 => ((IJavaScriptExecutor)driver).ExecuteScript("return document.readyState").Equals("complete"));
                driver.FindElement(By.XPath("//*[@id='button-action']")).Click();
            ...
            void proceso()
            {
                ...
                // Changes to controls must be performed on the UI thread.
                BeginInvoke((Action)(() => statusLabel.Text = @"Proceso... (2/6)"));
                BeginInvoke((Action)(() => statusLabel.ForeColor = Color.White));
                ...
                try
                {
                    WebElement inptnum = (WebElement)driver.FindElement(By.XPath("//*[@id='input-phone']"));
                    IJavaScriptExecutor js = (IJavaScriptExecutor)driver;
                    js.ExecuteScript("arguments[0].scrollIntoView();", inptnum);
                    driver.FindElement(By.XPath("//*[@id='input-phone']")).SendKeys("3059511239784");
                    driver.FindElement(By.XPath("//*[@id='input-postal-code']")).SendKeys("33122");
                }
                catch
                {
                    Thread.Sleep(3000);
            ...
            void agregandocc()
            {
                ...
                try
                {
                    ...
                    driver.FindElement(By.XPath("//*[@id='credit-card-number']")).SendKeys(cc);
                    driver.SwitchTo().DefaultContent();

                    driver.SwitchTo().Frame(driver.FindElement(By.XPath("//*[@id='braintree-hosted-field-expirationDate']")));
                    driver.FindElement(By.XPath("//*[@id='expiration']")).SendKeys(month + year);
                    driver.SwitchTo().DefaultContent();
            ...
            void click()
            {
                ...
                try
                {
                    WebElement agg = (WebElement)driver.FindElement(By.XPath("//*[@id='braintree-container']/div/div[1]/div[5]/div[4]/div/div[1]"));

                    IJavaScriptExecutor js = (IJavaScriptExecutor)driver;
                    js.ExecuteScript("arguments[0].scrollIntoView();", agg);
                    js.ExecuteScript("arguments[0].click();", agg);
                }
                catch
                {
                    Thread.Sleep(3000);
            ...
            void validar()
            {
                ...
                if (driver.PageSource.Contains("Do Not Honor") || driver.PageSource.Contains("Authorization Required") || driver.PageSource.Contains("payment_method_nonce") || driver.PageSource.Contains("No Account") || driver.PageSource.Contains("Invalid Credit Card Number") || driver.PageSource.Contains("Failed to process the payment"))
                {
                ...
                else if (driver.PageSource.Contains("Confirm your spot!") || driver.PageSource.Contains("Sign In to Your Account"))
                {
